...
Only requiring some minor changes is ava.cpp.
...
Changes to ava.cpp
----------------------
ava.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
