...
This mechanism has been integrated into Bitcore-Node-Ava which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/avapay/insight-api-ava#web-socket-api](https://github.com/avapay/insight-api-ava#web-socket-api)
* API: [https://github.com/avapay/insight-api-ava#instantsend-transactions](https://github.com/avapay/insight-api-ava#instantsend-transactions)
...
By default, the Ava Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Ava Core daemon:
