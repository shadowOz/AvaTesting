 ...
 *
 *   // network
 *   CAvaNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.ava.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CAvaNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: AvaNetwork
// //   -- signature requirements : Key1(User)
// class CAvaNetworkVariable : public CGovernanceObject
// {
// private:
