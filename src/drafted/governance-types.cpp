...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "AvaNetwork") type = AvaNetwork;
    if(strType == "AvaNetworkVariable") type = AvaNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == AvaNetwork) s = "AvaNetwork";
    if(type == AvaNetworkVariable) s = "AvaNetworkVariable";
