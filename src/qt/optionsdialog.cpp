    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("AVA-light"), QVariant("light"));
    ui->theme->addItem(QString("AVA-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("AVA-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("AVA-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("AVA-traditional"), QVariant("trad"));
