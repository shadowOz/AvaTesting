    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Ava Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Ava Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  ava-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Ava in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 AVA, 0.1 AVA, 1 AVA and 10 AVA -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://avapay.atlassian.net/wiki/display/DOC/PrivateSend\">https://avapay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Ava Core is shutting down...") + "<br /><br />" +
