    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Ava Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ava address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ava: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Ava Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ava Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ava Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ava addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ava addresses"));
    ...
    openAction->setStatusTip(tr("Open a ava: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ava Core help message to get a list with possible Ava Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Ava Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ava network", "", count));
    } else {
...
{
    QString strTitle = tr("Ava Core"); // default title
